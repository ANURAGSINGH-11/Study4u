            ...
            <div style={{textAlign:'center'}}>
               ...
               <Col span={24}>
                    <Card style={{ width: 300,margin:'auto',marginTop:'50px',borderRadius:'10px',border:'1px solid tomato' }}>
                        ...
                        <img src="https://study4u.in/wp-content/uploads/2020/11/student.png" alt='platform1' style={{width:'100px'}}/><br/>
                        <Button danger href="https://college.study4u.in" style={{marginTop:'10px'}}>Know more</Button>
                        
                        
                        <h5 style={{marginTop:50,fontSize:'20px',color:'#0070A6',fontWeight:'300'}}>Compiler.Study4u.in</h5>
                        <p style={{fontSize:'20px'}}>
                        ...
                        <img src="https://study4u.in/wp-content/uploads/2020/11/data.png" alt='platform2' style={{width:'100px'}}/><br/>
                        ...
                        <img src="https://study4u.in/wp-content/uploads/2020/11/world.png" alt='platform2' style={{width:'100px'}}/><br/>

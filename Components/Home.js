  ...
  0 9px 28px 8px rgba(0, 0, 0, 0.05)` }}>
                    ...
                    <Col span={24}>
                      ...
                      <Col span={24} style={{height:300}}>
                        <img style={{width:100}} src="https://study4u.in/wp-content/uploads/2020/11/student.png" alt='college-platform'/>
                      ...
                      <Col span={24} style={{height:300}}>
                        <img style={{width:100}} src="https://study4u.in/wp-content/uploads/2020/11/data.png" alt='college-platform'/>
                        <h2 style={{marginTop:20,fontSize:'20px',color:'#0070A6',fontWeight:'300'}}>Compiler.Study4U.in</h2>
                        <p>
                        This platform/service is made for the compilation /interpretation of any programming languages. Its a single plac. to run your code, edit and view the output. And improve your coding knowledge. ​
                        </p>
                        <Button danger>Visit Now</Button>
                      </Col>
                      <Col span={24} style={{height:300}}>
                        <img style={{width:100}} src="https://study4u.in/wp-content/uploads/2020/11/world.png" alt='college-platform'/>
